...
<div class="grid-2" style="display:grid; grid-template-columns: 2fr 1fr; gap:1.5rem;">
  <div>
      ...
      <div class="table-card" style="padding:1.5rem; border:1.5px solid #a855f7;">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1rem;">
          <h3 style="font-size:1.1rem; color:var(--text-main); margin:0;">
            <i class="fa-solid fa-microscope" style="color:var(--primary);"></i> Expert Deliverables & QA Files (<?php echo count($solutionFiles); ?>)
          </h3>
    ...
    <div class="table-card" style="padding:1.5rem;">
      <h3 style="font-size:1.1rem; margin-bottom:1rem; color:var(--text-main);"><i class="fa-solid fa-paperclip" style="color:var(--success);"></i> Student Brief & Uploaded Materials (<?php echo count($briefFiles); ?>)</h3>
      <?php if (empty($briefFiles)): ?>
        <p style="color:var(--text-muted); font-size:0.9rem;">No student brief files uploaded yet.</p>
      <?php else: ?>
        <div style="display:flex; flex-direction:column; gap:10px;">
